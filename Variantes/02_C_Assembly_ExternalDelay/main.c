...
/*
 * La funcion vive en delay_riscv.S.
 * El valor se calibra experimentalmente para el reloj real de la placa.
 */
extern void riscv_delay_cycles(uint32_t iterations);
